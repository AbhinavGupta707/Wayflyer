// Keeper frontend types — MIRROR of packages/contracts/types.ts.
// Kept as a local copy so the web app type-checks without a monorepo path alias.
// If a field changes in CONTRACTS.md, update packages/contracts/types.ts AND this file.
